...
public class AddNewSecurityGuards implements Initializable {
    @Override
    ...
    void add(ActionEvent event) {
        ...
        else { confirmation = popUpBox.confirmation("Confirmation","Do you want to ADD this (" + name + ") Security Guard???"); }


        if(confirmation.compareTo("yes") == 0) {
            Employee employee = new Employee();
            employee.add("Security Guard", name, age, gender, contractNumber, email, address, qualification, joiningDate, salary, shift);
            popUpBox.information("Information","This (" + name + ") Security Guard is successfully added");
