...
public class SearchNurse implements Initializable {
    @Override
    ...
    void search(ActionEvent event) {
        try {
            ...
            employee = (Employee) employee.search("Nurse", nurseName.getText());
            if(employee != null){
                ...
                popUpBox.waring("Warning","There is no Nurse in this (" + nurseName.getText() + ") name");
            }
        }
        catch (Exception e){
