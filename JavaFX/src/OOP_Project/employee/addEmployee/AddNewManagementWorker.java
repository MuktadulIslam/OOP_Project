...
public class AddNewManagementWorker implements Initializable {
    @Override
    ...
    void add(ActionEvent event) {
        ...
        else { confirmation = popUpBox.confirmation("Confirmation","Do you want to ADD this (" + name + ") Management Worker???"); }


        if(confirmation.compareTo("yes") == 0) {
            Employee employee = new Employee();
            employee.add("Management Worker", name, age, gender, contractNumber, email, address, qualification, joiningDate, salary, shift);
            popUpBox.information("Information","This (" + name + ") Management Worker is successfully added");
