...
public class SearchCleaner implements Initializable {
    @Override
    ...
    void search(ActionEvent event) {
        try {
            ...
            employee = (Employee) employee.search("Cleaner", cleanerName.getText());
            if(employee != null){
                ...
                popUpBox.waring("Warning","There is no Cleaner in this (" + cleanerName.getText() + ") name");
            }
        }
        catch (Exception e){
